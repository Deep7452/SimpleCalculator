...
public class MainActivity extends AppCompatActivity  implements View.OnClickListener {
    ...
    MaterialButton buttonDivide, buttonMultiply, buttonAddition, buttonSubstraction, buttonsEqual;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignId(buttonSubstraction, R.id.button_substract);
        assignId(buttonsEqual, R.id.button_equal);
